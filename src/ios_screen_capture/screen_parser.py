...
def get_phone_rect(hwnd):
    ...
    edge_cols = [(0, 0, 0), (16, 16, 16), (17, 17, 17),
                 (52, 52, 52), (77, 77, 77), (255, 255, 255)]
...
def get_starting_state():
    ...
    ref_points = [(0.5, 0.15), (0.5, 0.17), (0.5, 0.19),
                  (0.5, 0.21), (0.5, 0.23), (0.5, 0.25), (0.5, 0.27)]
    tile_points = [(0.425, 0.469), (0.451, 0.467), (0.538, 0.498), (0.625, 0.527), (0.711, 0.539), (0.799, 0.549), (0.943, 0.594), (0.316, 0.485), (0.405, 0.51), (0.49, 0.537), (0.58, 0.568), (0.664, 0.577), (0.75, 0.589), (0.836, 0.605), (0.268, 0.53), (0.355, 0.553), (0.442, 0.579), (0.531, 0.607), (0.615, 0.619), (0.704, 0.634), (0.789, 0.651), (0.221, 0.577), (0.307, 0.598), (0.394, 0.621),
                   (0.48, 0.649), (0.567, 0.664), (0.655, 0.679), (0.742, 0.697), (0.174, 0.604), (0.262, 0.629), (0.344, 0.651), (0.435, 0.679), (0.522, 0.693), (0.609, 0.708), (0.693, 0.725), (0.122, 0.629), (0.211, 0.654), (0.298, 0.683), (0.385, 0.712), (0.471, 0.724), (0.557, 0.734), (0.645, 0.751), (0.131, 0.69), (0.163, 0.685), (0.25, 0.716), (0.337, 0.746), (0.423, 0.757), (0.51, 0.767), (0.59, 0.792)]
    ...
    rgb_cols = [
        get_colour_at(x + p[0]*width, y + p[1]*height, dc)
        for p in ref_points
    ]

    true_cols = [
        scale_hsv(colorsys.rgb_to_hsv(
            *col
        ))
        for col in rgb_cols
    ]
    index_map = {
        col: i for i, col in enumerate(true_cols)
    }
    ...
    board = [
        [group_map[(x, y)] for x in range(7)]
        for y in range(7)
    ]
