...
def get_phone_rect(hwnd):
    ...
    edge_cols = [(0,0,0), (16,16,16), (17,17,17), (52,52,52), (77, 77, 77), (255,255,255)]
...
def get_starting_state():
    ...
    return (
        ...
        get_colour_at(x, y, dc),                        # Background colour (top)
        get_colour_at(x, y + height*0.8, dc)            # Bakcground colour (bottom)
    )
